<aside class="p-5 rounded-xl shadow-sm h-full bg-white flex flex-col justify-between">
    ...
    <section id="widget_2" class="mt-5 flex flex-col gap-5">
        <div class="flex gap-2 items-center bg-slate-600 hover:bg-slate-400 duration-200 transition-colors cursor-pointer text-white rounded-lg px-3 p-2  ">
