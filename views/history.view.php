...
<div class="mt-10 flex flex-col relative gap-6">
    <div class="border-b pb-2 border-gray-700">
        <h1 class="text-xl text-white">Your Session History </h1>
         <h1 class="text-sky-600"><?php echo $user['first_name'];?></h1>
    </div>

    <div class="bg-slate-800   rounded-lg flex flex-col ">
        <div class="overflow-x-auto flex-wrap text-white  gap-3 flex items-center justify-between p-5 border-b border-gray-700">
            ...
            <!-- <div class="text-white flex gap-3 items-center">
                ...
                <div class="bg-gray-950 p-2 -1.312T14 px-2 rounded-md flex gap-1 items-center">
                    ...
                    <input id="search" type="text" placeholder="Search students..."
                        class="text-white text-sm bg-transparent outline-none border-none" />
                </div>
            </div> -->
        ...
        <div class="overflow-x-auto">
            ...
            <div class="text-white p-5 flex justify-between text-sm mt-5 border-t border-gray-600">
                <div>
