<div class="mt-10 flex flex-col relative gap-6">
    ...
    <div class="border-b pb-2 border-gray-700">
        <h1 class="text-xl">Bookings / Reservations</h1>
    </div>
            ...
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 ">
                ...
                <?php foreach($books as $book) : ?>
                    ...
                    <tr class="odd:bg-gray-700 bg-slate-800">
                                ...
                                <td class="border px-4 py-4 border-none text-center text-xs md:text-sm text-white"><?php echo $book['first_name'];?> <?php echo $book['last_name'];?></td>
                                ...
                                <td class="border px-4 py-4 border-none text-center text-xs md:text-sm text-white"><?php echo ($book['status'] == 'Pending' ? '<div class="flex justify-center items-center gap-2"><a href="./accept?id='.$book['student_id'].'&bid='.$book['bid'].'" class="bg-green-500 p-2 rounded-md">Accept</a><a href="./reject?id='.$book['student_id'].'&bid='.$book['bid'].'" class="bg-red-500 p-2 rounded-md">Reject</a></div>' : $book['status'])?></td>
                               </tr>
                <?php endforeach;?>
