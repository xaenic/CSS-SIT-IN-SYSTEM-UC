<div class="mt-10 flex flex-col gap-6">
    ...
    <div class="flex justify-end">
        <a href="new_schedule" class="px-3 p-2 bg-slate-800  rounded-md hover:bg-blue-900 duration-200 transition-colors flex items-center gap-1">
    ...
    <div class="bg-slate-800   rounded-lg flex flex-col ">
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 ">
                <thead class="text-xs bg-gradient-to-l to-slate-800 from-gray-900 uppercase ">
                    <tr>
                        ...
                        <th class="border px-4 py-4 font-medium border-none text-slate-300 text-center">DAY</th>
                        <th class="border px-4 py-4 font-medium border-none text-slate-300 text-center">START TIME</th>
                        <th class="border px-4 py-4 font-medium border-none text-slate-300 text-center">END TIME</th>
                ...
                <tbody class="">
                    ...
                    foreach ($schedules as $schedule) {
                        ...
                        <td class="border px-4 py-4 border-none text-center text-xs md:text-sm text-white">' . $schedule['id'] . '</td>
                        <td class="border px-4 py-4 border-none text-center text-xs md:text-sm text-white">' . $schedule['day'] . '</td>
                        <td class="border px-4 py-4 border-none text-center text-xs md:text-sm text-white">' . $schedule['start_time'] . '</td>
                        <td class="border px-4 py-4 border-none text-center text-xs md:text-sm text-white">' . $schedule['end_time']  . '</td>
            ...
            <div class="p-5 flex justify-between text-sm mt-5 border-t border-gray-600">
                <div>
                    Showing 1 to 1 of <?php echo count($schedules); ?> entries
                </div>
                <div>
                    prev next
                </div>
