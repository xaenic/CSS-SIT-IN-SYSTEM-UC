    ...
    <div class="bg-slate-800   rounded-lg flex flex-col ">
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 ">
                ...
                <tbody class="">
                    ...
                    foreach ($staffs as $staff) {
                        ...
                        <td class="border px-4 py-4 border-none text-center text-xs md:text-sm text-white">' . $staff['id'] . '</td>
                        <td class="border px-4 py-4 border-none text-center text-xs md:text-sm text-white">' . $staff['first_name'] . '</td>
                        <td class="border px-4 py-4 border-none text-center text-xs md:text-sm text-white">' . $staff['last_name'] . '</td>
                        <td class="border px-4 py-4 border-none text-center text-xs md:text-sm text-white">' . $staff['email']  . '</td>
            ...
            <div class="p-5 flex justify-between text-sm mt-5 border-t border-gray-600">
                <div>
                    Showing 1 to 1 of <?php echo count($staffs); ?> entries
                </div>
                <div>
                    prev next
                </div>
