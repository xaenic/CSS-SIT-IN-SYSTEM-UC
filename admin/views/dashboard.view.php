<div class="flex flex-wrap  items-center  mt-8 gap-4">
    <div class="bg-slate-800  text-white p-5 w-full lg:w-72 rounded-md flex flex-col gap-3">
        ...
        <div class="flex flex-col gap-3">
            <h1 class="text-2xl font-semibold"><?php echo count($students); ?></h1>
            <span class="text-slate-300 "><?php echo $disabled; ?> Disabled</span>
        </div>
    </div>
    <div class="bg-slate-800  text-white p-5 w-full lg:w-72 rounded-md flex flex-col gap-3">
        <div class="flex justify-between items-center">
        ...
        <div class="flex flex-col gap-3">
            <h1 class="text-2xl font-semibold"><?php echo count($labs); ?></h1>
            <span class="text-slate-300 "><?php echo $disabled_labs; ?> Disabled</span>
        </div>
    </div>
    <div class="bg-slate-800  text-white p-5 w-full lg:w-72 rounded-md flex flex-col gap-3">
        <div class="flex justify-between items-center">
        ...
        <div class="flex flex-col gap-3">
            <h1 class="text-2xl font-semibold">256</h1>
            <span class="text-slate-300 ">36 Disabled</span>
        </div>
    </div>
    <div class="bg-slate-800  text-white p-5 w-full lg:w-72 rounded-md flex flex-col gap-3">
        <div class="flex justify-between items-center">
